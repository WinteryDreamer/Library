...
library.theme = {
    ...
    tilesize = 90,
    cursor = false,
    cursorimg = "https://t4.ftcdn.net/jpg/10/58/65/55/360_F_1058655557_2wyYbZ4iOBWwwA4Kg8bhuJD92t0wEsmp.jpg",
    backgroundcolor = Color3.fromRGB(221, 46, 68),
    tabstextcolor = Color3.fromRGB(240, 240, 240),
    bordercolor = Color3.fromRGB(60, 60, 60),
    accentcolor = Color3.fromRGB(221, 46, 68),
    accentcolor2 = Color3.fromRGB(221, 46, 68),
